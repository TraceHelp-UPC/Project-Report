...
| :---: | :--- | :---: | :--- |
| ![Cassius Martel](assets/images/profile_cassius_martel.png) | **Cassius Estefano Martel Andrade** | u202312287 | Estudiante de la carrera de Ingeniería de Software de la UPC. Se caracteriza por su liderazgo colaborativo, responsabilidad y enfoque analítico en la gestión y especificación de requerimientos de software. Cuenta con conocimientos técnicos en lenguajes como Python, Java y C++, así como en frameworks de desarrollo Frontend, bases de datos relacionales y no relacionales, arquitecturas de software y metodologías ágiles. |
